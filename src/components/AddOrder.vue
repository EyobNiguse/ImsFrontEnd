              ...
              <table>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button class="btn-submit" @click="addOrder" type="button">Finish</button>
          ...
          <fieldset class="view-items-container">
            ...
            <table class="view-items">
              ...
              <tr :name="x.ItemType" v-bind:key="x.ItemType" v-for="(x) in items">
                ...
                <td>
                  <button class="btn-err" @click="removeItem($event)">
        ...
        <div id="printThis">
          <table class="view-items" style>
            <tr class="view-items-header" style="  background: rgb(11, 170, 96);color:white;">
              ...
              <th style="padding:15px;">Price Per Quantity</th>
            </tr>
            <tr :name="x.ItemType" v-bind:key="x.ItemType" v-for="(x) in items">
...
export default {
  ...
  methods: {
    ...
    addOrder() {
      ...
      Orders.addSalesOrder(data)
        .then(res => {
          this.$confirm(
            "Order Added Successfully you can now print the Document",
            "SUCCESS",
            "success"
          ).then(text => {
