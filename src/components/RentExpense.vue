          ...
          <table>
            ...
            <fieldset class="view-items-container">
                    ...
                    <table class="view-items">
                      ...
                      <tr  :name="x.RentID" v-bind:key="x.RentID" v-for="(x) in displayedItems">  
                          <td>
                              {{x.RentType}}
                          </td>
                          <td>{{x.Date}}</td>
...
updateExpenseView(id){
    ...
    this.editCost = dt.Payment;

},updateBillExpense(){
    const data = {
    "Date":this.editDate,
    "RentType":this.editType,
    "Payment":this.editCost,
    "RentID":this.editableBill
